...
class ImageDatasets(object):
    ...
    def __init__(
        ...
        # self.new_path = "/data/users/ysw/LFA-plus/" 
        # self.split_path = os.path.join(self.new_path, self.split_path)
        # self.split_fewshot_dir = os.path.join(self.new_path, self.split_fewshot_dir)
